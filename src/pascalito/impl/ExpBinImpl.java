...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Exp Bin</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link pascalito.impl.ExpBinImpl#getOperador <em>Operador</em>}</li>
 *   <li>{@link pascalito.impl.ExpBinImpl#getOperandoDir <em>Operando Dir</em>}</li>
 *   <li>{@link pascalito.impl.ExpBinImpl#getOperandoEsq <em>Operando Esq</em>}</li>
 *   <li>{@link pascalito.impl.ExpBinImpl#isComutativa <em>Comutativa</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpBinImpl extends ExpressaoImpl implements ExpBin {
	/**
	...
	protected EClass eStaticClass() {
		return PascalitoPackage.Literals.EXP_BIN;
	}
	...
	public void setOperador(String newOperador) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PascalitoPackage.EXP_BIN__OPERADOR, oldOperador, operador));
	}
	...
	public NotificationChain basicSetOperandoDir(Expressao newOperandoDir, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalitoPackage.EXP_BIN__OPERANDO_DIR, oldOperandoDir, newOperandoDir);
	...
	public void setOperandoDir(Expressao newOperandoDir) {
		if (newOperandoDir != operandoDir) {
			...
			if (operandoDir != null)
				msgs = ((InternalEObject)operandoDir).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalitoPackage.EXP_BIN__OPERANDO_DIR, null, msgs);
			if (newOperandoDir != null)
				msgs = ((InternalEObject)newOperandoDir).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalitoPackage.EXP_BIN__OPERANDO_DIR, null, msgs);
			msgs = basicSetOperandoDir(newOperandoDir, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PascalitoPackage.EXP_BIN__OPERANDO_DIR, newOperandoDir, newOperandoDir));
	}
	...
	public NotificationChain basicSetOperandoEsq(Expressao newOperandoEsq, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalitoPackage.EXP_BIN__OPERANDO_ESQ, oldOperandoEsq, newOperandoEsq);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOperandoEsq(Expressao newOperandoEsq) {
		if (newOperandoEsq != operandoEsq) {
			NotificationChain msgs = null;
			if (operandoEsq != null)
				msgs = ((InternalEObject)operandoEsq).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalitoPackage.EXP_BIN__OPERANDO_ESQ, null, msgs);
			if (newOperandoEsq != null)
				msgs = ((InternalEObject)newOperandoEsq).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalitoPackage.EXP_BIN__OPERANDO_ESQ, null, msgs);
			msgs = basicSetOperandoEsq(newOperandoEsq, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PascalitoPackage.EXP_BIN__OPERANDO_ESQ, newOperandoEsq, newOperandoEsq));
	}
	...
	public void setComutativa(boolean newComutativa) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PascalitoPackage.EXP_BIN__COMUTATIVA, oldComutativa, comutativa));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PascalitoPackage.EXP_BIN__OPERANDO_DIR:
				return basicSetOperandoDir(null, msgs);
			case PascalitoPackage.EXP_BIN__OPERANDO_ESQ:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PascalitoPackage.EXP_BIN__OPERADOR:
				return getOperador();
			case PascalitoPackage.EXP_BIN__OPERANDO_DIR:
				return getOperandoDir();
			case PascalitoPackage.EXP_BIN__OPERANDO_ESQ:
				return getOperandoEsq();
			case PascalitoPackage.EXP_BIN__COMUTATIVA:
				return isComutativa();
		}
