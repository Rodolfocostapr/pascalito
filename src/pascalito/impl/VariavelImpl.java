...
public class VariavelImpl extends MinimalEObjectImpl.Container implements Variavel {
	...
	protected EClass eStaticClass() {
		return PascalitoPackage.Literals.VARIAVEL;
	}
	...
	public void setTipo(String newTipo) {
		...
		tipo = newTipo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PascalitoPackage.VARIAVEL__TIPO, oldTipo, tipo));
	}
	...
	public void setValor(String newValor) {
		...
		valor = newValor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PascalitoPackage.VARIAVEL__VALOR, oldValor, valor));
	}
